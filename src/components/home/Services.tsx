    ...
    <section id="services" className="bg-white py-16 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="container">
          <h2 className="text-[#cf1b1b] text-4xl font-bold mb-2">
            Our Services
          </h2>
          <p className="text-gray-600 text-sm">
            View all the services available in ServeIQ.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            ...
            >
              ...
              {/* Button */}
              <button className="bg-primary text-white px-6 py-2 rounded-full text-sm font-semibold hover:bg-red-700 transition-colors flex items-center gap-2">
                View Details
                <svg
                  className="w-4 h-4"
                  fill="none"
